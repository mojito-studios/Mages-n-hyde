...
public class OptionsChosen : NetworkBehaviour
{
    ...
    private void SetPlayerReadyServerRpc(RpcParams RpcParams = default)
    {
        ...
        foreach (System.Collections.Generic.KeyValuePair <ulong, bool> client in playerReadyDictionary)
        {
            ...
            {
                //algun jugador no est� listo a�n
    ...
    public int GetPlayerDataIndexFromClientId(ulong clientId) //Devuelve la posici�n en la lista del jugador correspondiente al id
    {
